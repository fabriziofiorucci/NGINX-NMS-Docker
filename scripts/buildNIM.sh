...
-P [version]\t\t- Enable WAF policy compiler, version can be any [v3.1088.2|v4.2.0|v4.100.1|v4.218.0|v4.279.0|v4.402.0] - optional\n
...
\t\t-A -W -P v4.2.0 -D -t my.registry.tld/nginx-nms:2.6.0\n
"
